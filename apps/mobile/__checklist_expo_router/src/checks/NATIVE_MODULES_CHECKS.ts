...
export const NATIVE_MODULES_CHECKS: Array<CheckItem | string> = [
  ...
  },
  {
    ...
    nativeModuleVersion: findVersion('@react-native-async-storage/async-storage'),
  },
  {
    id: 'EXPO-SETTINGS',
    url: '/expo-settings',
    title: 'Expo Settings',
    description: 'Expo Settings',
    checkedIos: 'checked',
    checkedAndroid: 'checked',
    nativeModuleName: '@acme/expo-settings',
    nativeModuleVersion: findVersion('@acme/expo-settings'),
  },
];
